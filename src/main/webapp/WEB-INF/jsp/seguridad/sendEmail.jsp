...
<head>
	...
	<script src="${pageContext.request.contextPath}/js/seguridad/validateEmail.js"></script>
</head>
<body class="top-navigation bg-login" onLoad="setTimeout('redirect()', 200000)">
	<div id="wrapper">
		<div id="login">
					...
					<div class="row">
						...
						<div class="col-sm-6 col-lg-6 form-login">
							<div class="wrapper-content">
								...
								<hr>								
								<form method="POST" role="form"	class="form-horizontal" id="sendEmail-form">
								<input type="hidden" id="${_csrf.parameterName}" name="${_csrf.parameterName}" value="${_csrf.token}" />
									<div class="form-group">
										<label class="col-lg-4 control-label">Digite su Email</label>
										<div class="col-lg-8">
											<input type="email" class="form-control" required="" id="enviarEmail" name="enviarEmail" tabindex="2" onkeydown="codigoTecla()">
										</div>
									</div>									
									<hr>
									<div align="right">
										<div id="email" >
											<input type="button" value="Enviar" id="checkemail" class="btn btn-sm btn-white"  onclick="existeEmail()" ></input>
										</div>
										<br>
										<div id="canelar">
