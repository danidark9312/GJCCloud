					...
					<div id="formularioPrestamo" name="formularioPrestamo">
						...
						<div class="row">
							<div class="col-sm-4 b-r">
								<div class="input-group m-b">
									<span class="input-group-addon">$</span>
									<input type="text" class="form-control" id="txtInteresesModal" disabled>
									<span class="input-group-addon">.00</span>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" id="txtTituloValorModal" disabled
									maxlength="30">
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-4 b-r">
								<div class="input-group m-b">
									<span class="input-group-addon">$</span>
									<input type="text" class="form-control" id="txtSaldoTotal" disabled>
									<span class="input-group-addon">.00</span>
								</div>
							</div>
							<div class="col-sm-4 b-r">
								<div class="input-group m-b">
									<span class="input-group-addon">$</span>
									<input type="text" maxlength="12" class="form-control" id="txtTotalPagado" disabled
										>
									<span class="input-group-addon">.00</span>
								</div>
							</div>
							<div class="col-sm-4 b-r">
								<input type="date" class="form-control" id="txtFechaCancelacionPrestamo" disabled
