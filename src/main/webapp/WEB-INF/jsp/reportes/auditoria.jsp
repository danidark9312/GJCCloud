											...
											<div class="ibox-content">
												<div class="panel blank-panel">
															...
															<ul class="nav nav-tabs">
																<li class="active">
																	<a data-toggle="tab" href="#tab-1">
																		<spring:message code="label.title.reportes.auditoria"></spring:message>
																	</a>
																</li>
															</ul>
														</div>
													...
													<div class="panel-body">
														<form role="form" class="panel-body" id="filtroAuditoriaForm">
															...
															<div class="tab-content">
																<div id="tab-1" class="tab-pane active">
																	...
																	<div class="form-group col-md-4 col-lg-4 col-xs-4 col-sm-4">
																			...
																			<input type="text" class="form-control" id="auditoriaNombreCasoFiltro"
																				name="auditoriaNombreCasoFiltro"></input>
																		</div>
																		...
																		<div class="form-group col-md-4 col-lg-4 col-xs-4 col-sm-4">
																			...
																			<input type="date" class="form-control" id="auditoriaFechaInicioFiltro"
																				onblur="validarFechaInicioFiltro()" name="auditoriaFechaInicioFiltro"></input>
																		</div>
																		<div class="form-group col-md-4 col-lg-4 col-xs-4 col-sm-4">
																			<label>
																				<spring:message code="label.filter.reportes.fechaFin"></spring:message>
																			</label>
																			<input type="date" class="form-control" id="auditoriaFechaFinFiltro" name="auditoriaFechaFinFiltro"
...
<!-- 																	</div> -->
			...
			<script src="js/reportes/auditoria.js"></script>
			...
			<script>
				var caso = "<spring:message code='label.menu.title.casos' />";
 				var moduloModificacion = "<spring:message code='label.title.reportes.auditoria.modulo' />";
 				var objetivoEliminado = "<spring:message code='label.title.reportes.auditoria.informacion' />";
 				var usuario = "<spring:message code='label.title.reportes.auditoria.usuario' />";
 				var fechaEliminacion = "<spring:message code='label.title.reportes.auditoria.fechaEliminacion' />";
 				var justificacion = "<spring:message code='label.title.reportes.auditoria.justificacion' />";
...
//  				var fechaVencimiento = "<spring:message code='label.title.reportes.audiencia.fechaVencimiento' />";
			...
			<script>
				$(document).ready(function(){
					...
					mostrarTabla();
// 					cargarResponsableJustificaciones();
					cargarCombox();
					var token = $("#_csrf").val();
