...
@Controller
@RequestMapping(value = { "/maestroCalendarioJudicial" })
public class MaestroCalendarioJudicialController {

	private static final Logger LOG = Logger.getLogger(MaestroCalendarioJudicialController.class);
	...
	public String getCreateForm(Model model, Locale loc, HttpServletRequest httpRequest, Principal principal) {
		...
		return "maestros/maestroCalendarioJudicial";
	}
