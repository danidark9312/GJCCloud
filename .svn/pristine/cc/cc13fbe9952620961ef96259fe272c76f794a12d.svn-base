...
<c:choose>
	<c:when test="${not empty permisos.rol.descripcion && cons.getParametroSiCorto() == permisos.listaRolAccionOpcion[0].snLectura}">
		<body>
															...
															<ul class="nav nav-tabs">
																<li class="active">
																	<a data-toggle="tab" href="#tab-1">
																		<spring:message code="label.title.reportes.recursosPendientes"></spring:message>
																	</a>
																</li>
															</ul>
														</div>
															...
															<div class="tab-content">
																<div id="tab-1" class="tab-pane active">
																	<div class="row">
																		...
																		<div class="form-group col-md-3">
																			<label>
																				<spring:message code="label.filter.reportes.ordernar.recursos.pendientes"></spring:message>
																			</label>
			...
			<script src="js/reportes/recursosPendientes.js"></script>
			...
			<script>
				...
				var despacho = "<spring:message code='label.title.reportes.recursosPendientes.despacho' />";
				var recursos = "<spring:message code='label.title.reportes.recursosPendientes.recurso' />";
