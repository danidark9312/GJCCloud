														...
														<div class="row">														
															...
															<div class="row" style= "text-align: right; padding-right: 1%;">
																	<div form-group col-md-3 btns-forms hidden-sm hidden-xs text-right>
																		<label></label>
																		<button class="btn btn-azul" type="button" onclick="mostrarTablaTipoCaso();">Filtrar</button>
																	</div>																
															</div>
														</div>
														<div class="row" style="text-align: right; padding-right: 1%;">
															<c:if test="${cons.getParametroSiCorto() == permisos.listaRolAccionOpcion[0].snCrear}">
																<a data-toggle="modal" onclick="mostrarModalNuvoTipoCaso()" class="btn btn-primary btn-circle .btn-xs"
																	style="background-color: #449D44; border: 0;"
																	title="<spring:message code="label.maestroTipoCaso.botonNuevo" />"> <i
			...
			<script src="js/plugins/select2/select2.min.js"></script>
				...
				<script>
					$(document).ready(function(){
						...
						$('#modalEscalamientoNotificacion').modal('hide');
						var config = {
							'.chosen-select' : {},
