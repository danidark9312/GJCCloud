...
import com.sf.social.signinmvc.security.util.SecurityUtil;
...
import com.sf.social.signinmvc.user.service.DuplicateEmailException;
...
public class RegistrationController {
    ...
    private RegistrationForm createRegistrationDTO(Connection<?> connection) {
        ...
        if (connection != null) {
            ...
            dto.setNombre(socialMediaProfile.getFirstName());
            dto.setApellido(socialMediaProfile.getLastName());
