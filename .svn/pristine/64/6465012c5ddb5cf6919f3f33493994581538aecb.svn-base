...
@EnableJpaRepositories(basePackages = {
        "com.sf.social.signinmvc.user.repository",
        "com.sf.repository"
})
...
public class PersistenceContext {
    ...
    private static final String[] PROPERTY_PACKAGES_TO_SCAN = {
    		"com.sf.social.signinmvc.user.model",
    		"com.sf.social.signinmvc.user.controller",
    		"com.sf.social.signinmvc.user.service",
    		"com.sf.social.signinmvc.user.repository",
            "com.sf.social.signinmvc.common.model",
            "com.sf.gja.gestionCasos.administradores.model",
