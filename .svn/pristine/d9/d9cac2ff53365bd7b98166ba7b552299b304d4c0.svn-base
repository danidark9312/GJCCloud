...
<c:choose>
	<c:when test="${not empty permisos.rol.descripcion && cons.getParametroSiCorto() == permisos.listaRolAccionOpcion[0].snLectura}">
		<body>
															...
															<ul class="nav nav-tabs">
																<li class="active">
																	<a data-toggle="tab" href="#tab-1">
																		<spring:message code="label.title.reportes.audiencia"></spring:message>
																	</a>
																</li>
															</ul>
														</div>
																...
																<div id="tab-1" class="tab-pane active">
																	<div class="row">
																		<div class="form-group col-md-3">
																			<label>
																				<spring:message code="label.filter.reportes.estado"></spring:message>
																			</label>
																			<select class="form-control" id="estadoTareaFiltro" name="estadoTareaFiltro">
																				<option value=""><spring:message code="label.title.reportes.seleccionar" /></option>
																				<option value="N"><spring:message code="label.title.reportes.pendiente" /></option>
																				<option value="S"><spring:message code="label.title.reportes.completada" /></option>
																				<option value="V"><spring:message code="label.title.reportes.vencida" /></option>
																			</select>
																		</div>
																		<div class="form-group col-md-3">
																			<label>
																		...
																		<div class="form-group col-md-3">
																			<label>
																				<spring:message code="label.filter.reportes.ordernar"></spring:message>
																			</label>
			...
			<script src="${pageContext.request.contextPath}/js/reportes/audiencia.js"></script>
