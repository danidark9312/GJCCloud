	<div id="modalAsociarArchivo" name="modalAsociarArchivo" class="modal fade"
		aria-hidden="true">	
						...
						<div class= "modal-body modal-scroll">	
									...
									<div class="col-lg-12">
										<div class="ibox float-e-margins">
											...
											<div class="ibox-content">
												...
												<form id="dropzone_asociarArchivo" class="dropzone" method="post"
							...
							<div class="row">
								<div class="form-group col-md-12 btns-forms hidden-sm hidden-xs text-right">
									...
									<button class="btn btn-azul" type="button" onclick="exportarArchivo();">
