...
<c:choose>
	<c:when test="${not empty permisos.rol.descripcion && cons.getParametroSiCorto() == permisos.listaRolAccionOpcion[0].snLectura}">
		<body>
									...
									<div class="col-md-12 col-lg-12">
										<div class="ibox float-e-margins">
											<div class="ibox-title">
												<h5>
													<springh:message code="label.title.reportes.reportes"></springh:message>
												</h5>
											</div>
															...
															<ul class="nav nav-tabs">
																<li class="active">
																	<a data-toggle="tab" href="#tab-1">
																		<spring:message code="label.title.reportes.documentosPendientes"></spring:message>
																	</a>
																</li>
															</ul>
														</div>
															...
															<div class="tab-content">
																<div id="tab-1" class="tab-pane active">
																	<div class="row">
																		...
																		<div class="form-group col-md-3">
																			<label>
																				<spring:message code="label.filter.reportes.ordernar.documentos.pendientes"></spring:message>
																			</label>
																			<Select type="text" class="form-control" id="ordenarPor" name="ordenarPor">
																				<option value="desc"><spring:message
																						code="label.title.reportes.masReciente" /></option>
																				<option value="asc"><spring:message
																						code="label.title.reportes.masAntigua" /></option>
																			</Select>
																		</div>
																		<div class="form-group col-md-3">
																			<label>
																	...
																	<div class="row">
																		<div class="form-group col-md-3">
																			...
																			<input type="text" class="form-control" id="victimaFiltro" name="victimaFiltro"></input>
																		</div>
																		<div class="form-group col-md-3">
																			<label>
																			...
																			<input type="date" class="form-control" id="fechaInicioFiltro"
																				onblur="validarFechaInicioFiltro()" name="fechaInicioFiltro"></input>
																		</div>
																		<div class="form-group col-md-3">
																			<label>
																				<spring:message code="label.filter.reportes.fechaFin"></spring:message>
																			</label>
																			<input type="date" class="form-control" id="fechaFinFiltro" name="fechaFinFiltro"
																				onblur="validarFechaFinFiltro()"></input>
																		</div>
																		<div class="form-group col-md-3 btns-forms">
																		</div>
																	</div>
																	<div class="row">
			...
			<script src="js/reportes/documentosPendientes.js"></script>
			...
			<script>
				...
				var nombreTitular = "<spring:message code='label.title.reportes.documentosPendientes.nombreTitular' />";
				var parentesco = "<spring:message code='label.title.reportes.documentosPendientes.parentesco' />";
				var documento = "<spring:message code='label.title.reportes.documentosPendientes.documento' />";
				var lugarDocumento = "<spring:message code='label.title.reportes.documentosPendientes.lugarDocumento' />";
				var fechaVencimiento = "<spring:message code='label.title.reportes.documentosPendientes.fechaVencimiento' />";
